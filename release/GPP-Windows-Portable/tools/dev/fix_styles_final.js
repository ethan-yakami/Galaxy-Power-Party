...
let css = fs.readFileSync(path.join(CLIENT_DIR, 'styles.css'), 'utf8');
...
fs.writeFileSync(path.join(CLIENT_DIR, 'styles.css'), css);
console.log('Done! styles.css fixed.');

// Also fix launcher.css
let launcherCss = fs.readFileSync(path.join(CLIENT_DIR, 'launcher.css'), 'utf8');
...
fs.writeFileSync(path.join(CLIENT_DIR, 'launcher.css'), launcherCss);
